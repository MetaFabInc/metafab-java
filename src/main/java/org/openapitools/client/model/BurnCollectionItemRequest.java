...
public class BurnCollectionItemRequest {
  ...
  public BurnCollectionItemRequest quantity(Integer quantity) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BurnCollectionItemRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
