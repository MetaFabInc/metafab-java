...
public class CreateCollection200Response {
  ...
  **/
  ...
  public CreateCollection200Response name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, createCollection200Response.id) &&
        ...
        Objects.equals(this.name, createCollection200Response.name) &&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateCollection200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
