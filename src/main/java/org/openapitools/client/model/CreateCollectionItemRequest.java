...
public class CreateCollectionItemRequest {
  ...
  public CreateCollectionItemRequest id(Integer id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "[B@2756c0a7", value = "A base64 string of the image for this item. Either `imageBase64` or `imageUrl` must be provided. Supported image formats are `jpg`, `jpeg`, `png`, `gif`. Recommended size of 1:1 aspect ratio and no more than 1500x1500 pixels.")
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateCollectionItemRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
