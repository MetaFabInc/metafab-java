...
public class CreateCollectionItemRequestAttributesInnerValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateCollectionItemRequestAttributesInnerValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateCollectionItemRequestAttributesInnerValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateCollectionItemRequestAttributesInnerValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CreateCollectionItemRequestAttributesInnerValue>() {
                @Override
                public void write(JsonWriter out, CreateCollectionItemRequestAttributesInnerValue value) throws IOException {
                ...
                @Override
                public CreateCollectionItemRequestAttributesInnerValue read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        CreateCollectionItemRequestAttributesInnerValue ret = new CreateCollectionItemRequestAttributesInnerValue();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for CreateCollectionItemRequestAttributesInnerValue: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CreateCollectionItemRequestAttributesInnerValue() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateCollectionItemRequestAttributesInnerValue(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateCollectionItemRequestAttributesInnerValue(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateCollectionItemRequestAttributesInnerValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CreateCollectionItemRequestAttributesInnerValue.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateCollectionItemRequestAttributesInnerValue
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for CreateCollectionItemRequestAttributesInnerValue with oneOf schemas: BigDecimal, Boolean, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CreateCollectionItemRequestAttributesInnerValue given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateCollectionItemRequestAttributesInnerValue
  * @throws IOException if the JSON string is invalid with respect to CreateCollectionItemRequestAttributesInnerValue
  */
  public static CreateCollectionItemRequestAttributesInnerValue fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCollectionItemRequestAttributesInnerValue.class);
  }

 /**
  * Convert an instance of CreateCollectionItemRequestAttributesInnerValue to an JSON string
  *
  * @return JSON string
  */
