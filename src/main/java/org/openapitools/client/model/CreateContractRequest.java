...
public class CreateContractRequest {
  ...
  **/
  ...
  public CreateContractRequest forwarderAddress(String forwarderAddress) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "SELECT ONE", required = true, value = "The blockchain you want to deploy this currency on. Support for new blockchains are added over time.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, createContractRequest.address) &&
        Objects.equals(this.forwarderAddress, createContractRequest.forwarderAddress) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(address, forwarderAddress, abi, chain);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateContractRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
