...
public class GetCollections200ResponseInnerAllOf {
  ...
  public GetCollections200ResponseInnerAllOf contract(ContractModel contract) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetCollections200ResponseInnerAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
