...
public class RemovePlayerConnectedWalletRequest {
  ...
  public RemovePlayerConnectedWalletRequest address(String address) {
  ...
  **/
  ...
  public RemovePlayerConnectedWalletRequest nonce(Integer nonce) {
  ...
  **/
  ...
  public RemovePlayerConnectedWalletRequest signature(String signature) {
  ...
  **/
  ...
  public RemovePlayerConnectedWalletRequest chain(ChainEnum chain) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "SELECT ONE", required = true, value = "The blockchain you want to remove this wallet connection on. If you need to remove it on multiple blockchains, make multiple requests using different `chain` arguments. Support for new blockchains are added over time.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.address, removePlayerConnectedWalletRequest.address) &&
        Objects.equals(this.nonce, removePlayerConnectedWalletRequest.nonce) &&
        Objects.equals(this.signature, removePlayerConnectedWalletRequest.signature) &&
        Objects.equals(this.chain, removePlayerConnectedWalletRequest.chain);
  }

  @Override
  public int hashCode() {
    return Objects.hash(address, nonce, signature, chain);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RemovePlayerConnectedWalletRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RemovePlayerConnectedWalletRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RemovePlayerConnectedWalletRequest is not found in the empty JSON string", RemovePlayerConnectedWalletRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RemovePlayerConnectedWalletRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RemovePlayerConnectedWalletRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RemovePlayerConnectedWalletRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemovePlayerConnectedWalletRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemovePlayerConnectedWalletRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemovePlayerConnectedWalletRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemovePlayerConnectedWalletRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RemovePlayerConnectedWalletRequest>() {
           @Override
           public void write(JsonWriter out, RemovePlayerConnectedWalletRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemovePlayerConnectedWalletRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RemovePlayerConnectedWalletRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RemovePlayerConnectedWalletRequest
  * @throws IOException if the JSON string is invalid with respect to RemovePlayerConnectedWalletRequest
  */
  public static RemovePlayerConnectedWalletRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemovePlayerConnectedWalletRequest.class);
  }

 /**
  * Convert an instance of RemovePlayerConnectedWalletRequest to an JSON string
  *
  * @return JSON string
  */
