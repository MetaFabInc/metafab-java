...
public class SetLootboxManagerLootboxRequest {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SetLootboxManagerLootboxRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("outputCollectionItemWeights") != null && !jsonObj.get("outputCollectionItemWeights").isJsonArray()) {
