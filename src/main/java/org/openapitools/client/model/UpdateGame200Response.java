...
public class UpdateGame200Response {
  ...
  public UpdateGame200Response id(String id) {
  ...
  **/
  ...
  public UpdateGame200Response walletId(String walletId) {
  ...
  **/
  ...
  public UpdateGame200Response fundingWalletId(String fundingWalletId) {
  ...
  **/
  ...
  public UpdateGame200Response email(String email) {
  ...
  **/
  ...
  public UpdateGame200Response name(String name) {
  ...
  **/
  ...
  public UpdateGame200Response rpcs(Object rpcs) {
  ...
  **/
  ...
  public UpdateGame200Response redirectUris(Object redirectUris) {
  ...
  **/
  ...
  public UpdateGame200Response iconImageUrl(String iconImageUrl) {
  ...
  **/
  ...
  public UpdateGame200Response coverImageUrl(String coverImageUrl) {
  ...
  **/
  ...
  public UpdateGame200Response primaryColorHex(String primaryColorHex) {
  ...
  **/
  ...
  public UpdateGame200Response publishedKey(String publishedKey) {
  ...
  **/
  ...
  public UpdateGame200Response secretKey(String secretKey) {
  ...
  **/
  ...
  public UpdateGame200Response verified(Boolean verified) {
  ...
  **/
  ...
  public UpdateGame200Response updatedAt(String updatedAt) {
  ...
  **/
  ...
  public UpdateGame200Response createdAt(String createdAt) {
  ...
  **/
  ...
  public UpdateGame200Response walletDecryptKey(String walletDecryptKey) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, updateGame200Response.id) &&
        Objects.equals(this.walletId, updateGame200Response.walletId) &&
        Objects.equals(this.fundingWalletId, updateGame200Response.fundingWalletId) &&
        Objects.equals(this.email, updateGame200Response.email) &&
        Objects.equals(this.name, updateGame200Response.name) &&
        Objects.equals(this.rpcs, updateGame200Response.rpcs) &&
        Objects.equals(this.redirectUris, updateGame200Response.redirectUris) &&
        Objects.equals(this.iconImageUrl, updateGame200Response.iconImageUrl) &&
        Objects.equals(this.coverImageUrl, updateGame200Response.coverImageUrl) &&
        Objects.equals(this.primaryColorHex, updateGame200Response.primaryColorHex) &&
        Objects.equals(this.publishedKey, updateGame200Response.publishedKey) &&
        Objects.equals(this.secretKey, updateGame200Response.secretKey) &&
        Objects.equals(this.verified, updateGame200Response.verified) &&
        Objects.equals(this.updatedAt, updateGame200Response.updatedAt) &&
        Objects.equals(this.createdAt, updateGame200Response.createdAt) &&
        Objects.equals(this.walletDecryptKey, updateGame200Response.walletDecryptKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, walletId, fundingWalletId, email, name, rpcs, redirectUris, iconImageUrl, coverImageUrl, primaryColorHex, publishedKey, secretKey, verified, updatedAt, createdAt, walletDecryptKey);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateGame200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateGame200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateGame200Response is not found in the empty JSON string", UpdateGame200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateGame200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGame200Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGame200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGame200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGame200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGame200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGame200Response>() {
           @Override
           public void write(JsonWriter out, UpdateGame200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGame200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UpdateGame200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateGame200Response
  * @throws IOException if the JSON string is invalid with respect to UpdateGame200Response
  */
  public static UpdateGame200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGame200Response.class);
  }

 /**
  * Convert an instance of UpdateGame200Response to an JSON string
  *
  * @return JSON string
  */
