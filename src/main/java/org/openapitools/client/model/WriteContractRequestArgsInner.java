...
public class WriteContractRequestArgsInner extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(WriteContractRequestArgsInner.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WriteContractRequestArgsInner.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WriteContractRequestArgsInner' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<WriteContractRequestArgsInner>() {
                @Override
                public void write(JsonWriter out, WriteContractRequestArgsInner value) throws IOException {
                ...
                @Override
                public WriteContractRequestArgsInner read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        WriteContractRequestArgsInner ret = new WriteContractRequestArgsInner();
                    ...
                    throw new IOException(String.format("Failed deserialization for WriteContractRequestArgsInner: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public WriteContractRequestArgsInner(BigDecimal o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public WriteContractRequestArgsInner(Boolean o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public WriteContractRequestArgsInner(String o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return WriteContractRequestArgsInner.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WriteContractRequestArgsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for WriteContractRequestArgsInner with anyOf schemas: BigDecimal, Boolean, String. JSON: %s", jsonObj.toString()));
    }
  }

 /**
  * Create an instance of WriteContractRequestArgsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WriteContractRequestArgsInner
  * @throws IOException if the JSON string is invalid with respect to WriteContractRequestArgsInner
  */
  public static WriteContractRequestArgsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WriteContractRequestArgsInner.class);
  }

 /**
  * Convert an instance of WriteContractRequestArgsInner to an JSON string
  *
  * @return JSON string
  */
